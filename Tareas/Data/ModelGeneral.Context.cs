...
namespace Data
{
    ...
    public partial class EntityTareas : DbContext
    {
        ...
        public virtual ObjectResult<SPGEN_001_Result> SPGEN_001(Nullable<System.DateTime> fechaInicio, Nullable<System.DateTime> fechaFin)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SPGEN_001_Result>("SPGEN_001", fechaInicioParameter, fechaFinParameter);
        }
    }
}
